   ...
   useEffect(() => {
      const loadLocations = async () => {
         try {
            ...
            const validPlaces = data.filter((place) => typeof place.lat === 'number' && typeof place.long === 'number');
         ...
         <div className="mx-auto my-10">
            <div className="flex flex-col sm:flex-row md:items-center justify-between">
               <button
                  ...
                  className="bg-base-color-1 hover:bg-base-color-2 text-[#ECECEC] py-5 px-20 mx-10 md:me-10 rounded text-sm transition ease-in-out delay-150 duration-300">
                  NOTIFY ME
               </button>
               <Formik
